            ...
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="inputNilai.html" class="nav-link"><i class="fa fa-laptop me-2" style="color: #191C24;"></i>Input Nilai</a>
                    </div>
                    <a href="editcpmk.html" class="nav-item nav-link"><i class="fa fa-chart-bar me-2" style="color: #191C24;"></i>Edit CPMK</a>
                    <a href="raport.html" class="nav-item nav-link active"><i class="fa fa-table me-2" style="color: #191C24;"></i>Raport</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <script>
                ...
                submitButton.addEventListener('click', function () {
                    ...
                    if (selectedOption === 'TSD') {
                        ...
                        url = '/query2';
                    } else if (selectedOption === 'TI') {
                        url = '/query3'; // Change the URL to the appropriate query
                    } else if (selectedOption === 'TRKB') {
                        url = '/query4';
                    } else if (selectedOption === 'RN') {
                        url = '/query5';
                    } else if (selectedOption === 'mhs_TSD') {
                        url = '/query6';
                    } else if (selectedOption === 'mhs_TE') {
                        url = '/query7';
                    } else if (selectedOption === 'mhs_TI') {
                        url = '/query8';
                    } else if (selectedOption === 'mhs_TRKB') {
                        url = '/query9';
                    } else if (selectedOption === 'mhs_RN') {
                        url = '/query10';
                    }
