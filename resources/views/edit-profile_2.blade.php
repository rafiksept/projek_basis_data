            ...
            <div class="edit-personal" style="margin-bottom: 5%;">
                ...
                <div style="width: 50%; margin: 0 auto; margin-top: 3%;" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" style="background-color: white; border: 1px solid grey;" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class=" mb-3">
                        ...
                        <input type="number" class="form-control" id="nik" name="nik"  style="background-color: white; border: 1px solid grey;">
                    </div>
