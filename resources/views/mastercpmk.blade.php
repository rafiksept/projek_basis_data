...
<head>
    ...
    <link href="{{asset("css/componentStyle.css")}}" rel="stylesheet">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">
                    <a href="/viewIndex" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a href="/editcpmk" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"
